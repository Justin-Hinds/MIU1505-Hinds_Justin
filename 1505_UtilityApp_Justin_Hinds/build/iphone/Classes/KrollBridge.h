...
@interface k1505_UtilityApp_Justin_HindsObject : KrollCoverageObject {
#else
@interface k1505_UtilityApp_Justin_HindsObject : KrollObject {
#endif
@private
...
extern NSString * k1505_UtilityApp_Justin_Hinds$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1505_UtilityApp_Justin_HindsObject *_k1505_utilityapp_justin_hinds;
    KrollObject* console;
	BOOL shutdown;
