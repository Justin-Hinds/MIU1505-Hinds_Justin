...
// in simulator we redefine to format for k1505_UtilityApp_Justin_Hinds Developer console
...
{\
	NSString * exceptionName = [@"org.k1505_utilityapp_justin_hinds." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1505_utilityapp_justin_hinds";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1505_UtilityApp_Justin_HindsNativeItemNone = -1, 
	UIk1505_UtilityApp_Justin_HindsNativeItemSpinner = -2,
	UIk1505_UtilityApp_Justin_HindsNativeItemProgressBar = -3,
	
	UIk1505_UtilityApp_Justin_HindsNativeItemSlider = -4,
	UIk1505_UtilityApp_Justin_HindsNativeItemSwitch = -5,
	UIk1505_UtilityApp_Justin_HindsNativeItemMultiButton = -6,
	UIk1505_UtilityApp_Justin_HindsNativeItemSegmented = -7,
	
	UIk1505_UtilityApp_Justin_HindsNativeItemTextView = -8,
	UIk1505_UtilityApp_Justin_HindsNativeItemTextField = -9,
	UIk1505_UtilityApp_Justin_HindsNativeItemSearchBar = -10,
	
	UIk1505_UtilityApp_Justin_HindsNativeItemPicker = -11,
	UIk1505_UtilityApp_Justin_HindsNativeItemDatePicker = -12,
	
	UIk1505_UtilityApp_Justin_HindsNativeItemInfoLight = -13,
	UIk1505_UtilityApp_Justin_HindsNativeItemInfoDark = -14,
	
	UIk1505_UtilityApp_Justin_HindsNativeItemDisclosure = -15,
	
	UIk1505_UtilityApp_Justin_HindsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1505_UtilityApp_Justin_Hinds instances of
