...
//@interface k1505_UtilityApp_Justin_HindsObject : NSObject
//@end

@interface k1505_UtilityApp_Justin_HindsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1505_UtilityApp_Justin_HindsObject class]])
		{
			for (NSString *key in [[(k1505_UtilityApp_Justin_HindsObject*)o modules] allKeys])
			{
