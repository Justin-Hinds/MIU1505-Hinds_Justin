 ...
 * to send analytic data that can be viewed on the k1505_UtilityApp_Justin_Hinds Dashboard.
 *
 * For information on getting started with k1505_UtilityApp_Justin_Hinds Platform Services,
