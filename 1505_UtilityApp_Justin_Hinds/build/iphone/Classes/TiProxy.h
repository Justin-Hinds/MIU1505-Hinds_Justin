...
//Rare exceptions to indicate a bug in the _k1505_utilityapp_justin_hinds code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1505_UtilityApp_Justin_Hinds proxies.
 */
