...
/**
 Base class for all k1505_UtilityApp_Justin_Hinds views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1505_UtilityApp_Justin_Hinds view hierarchy (such as wrapped iOS UIViews) was touched.
