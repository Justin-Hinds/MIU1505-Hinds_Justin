...
/**
 Base class for all k1505_InfoApp_HInds_Justin views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1505_InfoApp_HInds_Justin view hierarchy (such as wrapped iOS UIViews) was touched.
