 ...
 * to send analytic data that can be viewed on the k1505_InfoApp_HInds_Justin Dashboard.
 *
 * For information on getting started with k1505_InfoApp_HInds_Justin Platform Services,
