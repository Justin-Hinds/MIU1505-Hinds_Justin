...
@interface k1505_InfoApp_HInds_JustinObject : KrollCoverageObject {
#else
@interface k1505_InfoApp_HInds_JustinObject : KrollObject {
#endif
@private
...
extern NSString * k1505_InfoApp_HInds_Justin$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1505_InfoApp_HInds_JustinObject *_k1505_infoapp_hinds_justin;
    KrollObject* console;
	BOOL shutdown;
