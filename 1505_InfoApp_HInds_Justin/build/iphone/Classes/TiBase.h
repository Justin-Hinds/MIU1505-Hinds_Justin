...
// in simulator we redefine to format for k1505_InfoApp_HInds_Justin Developer console
...
{\
	NSString * exceptionName = [@"org.k1505_infoapp_hinds_justin." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1505_infoapp_hinds_justin";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1505_InfoApp_HInds_JustinNativeItemNone = -1, 
	UIk1505_InfoApp_HInds_JustinNativeItemSpinner = -2,
	UIk1505_InfoApp_HInds_JustinNativeItemProgressBar = -3,
	
	UIk1505_InfoApp_HInds_JustinNativeItemSlider = -4,
	UIk1505_InfoApp_HInds_JustinNativeItemSwitch = -5,
	UIk1505_InfoApp_HInds_JustinNativeItemMultiButton = -6,
	UIk1505_InfoApp_HInds_JustinNativeItemSegmented = -7,
	
	UIk1505_InfoApp_HInds_JustinNativeItemTextView = -8,
	UIk1505_InfoApp_HInds_JustinNativeItemTextField = -9,
	UIk1505_InfoApp_HInds_JustinNativeItemSearchBar = -10,
	
	UIk1505_InfoApp_HInds_JustinNativeItemPicker = -11,
	UIk1505_InfoApp_HInds_JustinNativeItemDatePicker = -12,
	
	UIk1505_InfoApp_HInds_JustinNativeItemInfoLight = -13,
	UIk1505_InfoApp_HInds_JustinNativeItemInfoDark = -14,
	
	UIk1505_InfoApp_HInds_JustinNativeItemDisclosure = -15,
	
	UIk1505_InfoApp_HInds_JustinNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1505_InfoApp_HInds_Justin instances of
