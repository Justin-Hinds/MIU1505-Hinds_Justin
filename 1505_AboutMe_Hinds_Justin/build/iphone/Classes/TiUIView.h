...
/**
 Base class for all k1505_AboutMe_Hinds_Justin views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1505_AboutMe_Hinds_Justin view hierarchy (such as wrapped iOS UIViews) was touched.
