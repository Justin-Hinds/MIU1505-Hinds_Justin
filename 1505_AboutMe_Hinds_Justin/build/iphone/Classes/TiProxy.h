...
//Rare exceptions to indicate a bug in the _k1505_aboutme_hinds_justin code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1505_AboutMe_Hinds_Justin proxies.
 */
