...
// in simulator we redefine to format for k1505_AboutMe_Hinds_Justin Developer console
...
{\
	NSString * exceptionName = [@"org.k1505_aboutme_hinds_justin." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1505_aboutme_hinds_justin";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1505_AboutMe_Hinds_JustinNativeItemNone = -1, 
	UIk1505_AboutMe_Hinds_JustinNativeItemSpinner = -2,
	UIk1505_AboutMe_Hinds_JustinNativeItemProgressBar = -3,
	
	UIk1505_AboutMe_Hinds_JustinNativeItemSlider = -4,
	UIk1505_AboutMe_Hinds_JustinNativeItemSwitch = -5,
	UIk1505_AboutMe_Hinds_JustinNativeItemMultiButton = -6,
	UIk1505_AboutMe_Hinds_JustinNativeItemSegmented = -7,
	
	UIk1505_AboutMe_Hinds_JustinNativeItemTextView = -8,
	UIk1505_AboutMe_Hinds_JustinNativeItemTextField = -9,
	UIk1505_AboutMe_Hinds_JustinNativeItemSearchBar = -10,
	
	UIk1505_AboutMe_Hinds_JustinNativeItemPicker = -11,
	UIk1505_AboutMe_Hinds_JustinNativeItemDatePicker = -12,
	
	UIk1505_AboutMe_Hinds_JustinNativeItemInfoLight = -13,
	UIk1505_AboutMe_Hinds_JustinNativeItemInfoDark = -14,
	
	UIk1505_AboutMe_Hinds_JustinNativeItemDisclosure = -15,
	
	UIk1505_AboutMe_Hinds_JustinNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1505_AboutMe_Hinds_Justin instances of
