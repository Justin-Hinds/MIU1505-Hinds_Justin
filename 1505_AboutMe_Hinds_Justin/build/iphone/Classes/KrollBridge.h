...
@interface k1505_AboutMe_Hinds_JustinObject : KrollCoverageObject {
#else
@interface k1505_AboutMe_Hinds_JustinObject : KrollObject {
#endif
@private
...
extern NSString * k1505_AboutMe_Hinds_Justin$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1505_AboutMe_Hinds_JustinObject *_k1505_aboutme_hinds_justin;
    KrollObject* console;
	BOOL shutdown;
