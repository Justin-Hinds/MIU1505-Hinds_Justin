...
//@interface k1505_AboutMe_Hinds_JustinObject : NSObject
//@end

@interface k1505_AboutMe_Hinds_JustinObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1505_AboutMe_Hinds_JustinObject class]])
		{
			for (NSString *key in [[(k1505_AboutMe_Hinds_JustinObject*)o modules] allKeys])
			{
